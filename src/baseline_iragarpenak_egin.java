...
public class baseline_iragarpenak_egin {
    public static void main(String[] args){
        if(args.length < 3){
            System.out.println("java -jar baseline_iragarpenak_egin.jar <testBlind.arff><model><baseline_iragarpenak.txt>");
            return;
        }
        ...
        try{ 
        	...
        	LinearRegression model = (LinearRegression) SerializationHelper.read(modelPath);
